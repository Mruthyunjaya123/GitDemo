...
public class SubmitOrder3Jsonformat extends BaseTest {
	...
	@Test(dataProvider="getdata", groups={"Purchase"})
	 ...
	 public Object[][] getdata() throws IOException
	 {
		 ...
		 List<HashMap<String, String>> data= getJsonDataToMap(System.getProperty("user.dir") + "\\test\\java\\TestData\\PurchaseOrder.json");
